package org.erym.im.client;

import org.erym.im.common.concurrent.FutureTaskScheduler;
import org.erym.im.common.model.entity.ImNode;
import org.erym.im.clientCommand.ChatConsoleCommand;
import org.erym.im.common.concurrent.FutureTaskScheduler;
import org.erym.im.common.model.dto.LoginBack;
import org.erym.im.common.model.dto.UserDTO;
import org.erym.im.ClientSender.ChatSender;
import org.erym.im.ClientSender.LoginSender;
import org.erym.im.clientCommand.*;
import org.erym.im.common.model.entity.ImNode;
import org.erym.im.common.util.JsonUtil;
import org.erym.im.feignClient.WebOperator;
import org.erym.im.common.util.JsonUtil;
...
public class CommandController
{
    ...
    private void userLoginAndConnectToServer()
    {
        ...
        user.setUserId(Long.valueOf(command.getUserName()));
        user.setClientId("1111");
        ...
        log.info("webBack:" + webBack);

        user.setToken(webBack.getAccessToken());
